            ...
            all_metrics["reconstruction_quality"].update(
                {
                    ...
                    "nmse": sparsity_variance_metrics["nmse"],
...
def get_sparsity_and_variance_metrics(
    ...
    for _ in batch_iter:
        ...
        if compute_variance_metrics:
            ...
            nmse = resid_sum_of_squares / flattened_sae_input.pow(2).sum(dim=-1)
...
#     repo_id = "adamkarvonen/saebench_pythia-160m-deduped_width-2pow16_date-0108"
#     filename = "TopK_pythia-160m-deduped__0108/resid_post_layer_8/trainer_1/ae.pt"
#     layer = 8
...
#     random_seed = 42
#     output_folder = "eval_results_test"
...
#     repo_id = "100fvu_hsic-1024k-gemma-2-2b-2000-resid_post_layer_8-5.0e+08-20250812_2003" #"100fvu_hsic-512k-gemma-2-2b-2000-resid_post_layer_8-5.0e+08-20250812_2003"
...
#         dtype,
#         layer=layer,
#         local_dir="final_saes_dictionary_learning/500M/hsic/"
#     )
